...
# you used different column names throughout but I don't see any renaming? so I added it here so your script would run for me

tribbles <- tribbles %>%
  rename(day = Days, population = Count)
